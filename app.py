        ...
        st.markdown("""
            <div class="glass-card delay-1">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <div style="height: 10px; background-color: rgba(255,255,255,0.08); border-radius: 999px; overflow: hidden;">
                        <div style="width: 88%; height: 100%; background: linear-gradient(90deg, #ef4444 0%, #f97316 100%); box-shadow: 0 0 10px rgba(239,68,68,0.6); border-radius: 999px;"></div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <div style="height: 10px; background-color: rgba(255,255,255,0.08); border-radius: 999px; overflow: hidden;">
                        <div style="width: 24%; height: 100%; background: linear-gradient(90deg, #22d3ee 0%, #38bdf8 100%); box-shadow: 0 0 10px rgba(34,211,238,0.55); border-radius: 999px;"></div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div style="height: 10px; background-color: rgba(255,255,255,0.08); border-radius: 999px; overflow: hidden;">
                        <div style="width: 12%; height: 100%; background: linear-gradient(90deg, #4ade80 0%, #22c55e 100%); box-shadow: 0 0 10px rgba(74,222,128,0.55); border-radius: 999px;"></div>
                    </div>
                </div>
            </div>
        """, unsafe_allow_html=True)
